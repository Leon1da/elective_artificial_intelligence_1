...
def main():
    ...
    for image_key in map_images_keys:
        ...
        Similarity, chi_evolution, num_inliers_evolution, similarity_evolution = scale_estimator_module.recover_similarity_transformation(points=points3d_coords, measurements=points3d_gt_coords)
        ...
        print('### Kernel threshold:', kernel_threshold)
        print('### Keypoints number:', total_segmented_keypoints)
        Transform, chi_evolution, num_inliers_evolution, transform_evolution = scale_estimator_module.recover_rigid_transformation(points=points3d_coords_similarity_correction, measurements=points3d_gt_coords)
        print('Transform')
        print(Transform)
